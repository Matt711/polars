...
class PyLazyFrame:
    ...
    def scan_from_python_function_arrow_schema(
        schema: Any, scan_fn: Any, pyarrow: bool, validate_schema: bool
    ) -> PyLazyFrame: ...
    @staticmethod
...
class PyExpr:
    ...
    def dt_epoch_seconds(self) -> PyExpr: ...
    ...
    def list_to_struct(
        self,
        width_strat: ListToStructWidthStrategy,
        name_gen: Any | None = None,
    ...
    def str_to_decimal(self, infer_len: int) -> PyExpr: ...
...
def read_parquet_metadata(py_f: Any) -> dict[str, str]: ...
...
class NodeTraverser:
    ...
    def set_udf(self, function: Any) -> None: ...
